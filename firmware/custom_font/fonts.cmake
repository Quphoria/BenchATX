...
add_custom_command(
    ...
    DEPENDS ${On_Icon_PATH} font_venv/ready FONT_VENV # target level dependency to avoid race condition
    COMMAND ./font_venv/${VENV_BIN_DIR}/python "${CMAKE_CURRENT_LIST_DIR}/font_to_header.py"
            -W 13 -H 11 -s 65 -c 1
            "${On_Icon_PATH}"
            -o "${On_Icon_H_PATH}"
...
add_custom_command(
    ...
    DEPENDS ${Chan_Icons_PATH} font_venv/ready FONT_VENV # target level dependency to avoid race condition
    COMMAND ./font_venv/${VENV_BIN_DIR}/python "${CMAKE_CURRENT_LIST_DIR}/font_to_header.py"
            -W 32 -H 16 -s 65 -c 5
            "${Chan_Icons_PATH}"
            -o "${Chan_Icons_H_PATH}"
